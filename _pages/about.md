...
redirect_from: 
  ...
  - /about.html
---
- Currently, a Ph.D. Student in Computer Science at "Université Laval" (https://www.ulaval.ca/), where I am also affiliated with "Mila – Quebec Artificial Intelligence Institute" (https://mila.quebec/fr) as a PhD Researcher and with the "Institut Intelligence et Données (IID)" (https://iid.ulaval.ca/) as a Student Researcher. Prior to this, I hold a Master's degree (M.Sc.) in Data Science from the "African Institute for Mathematical Sciences, Rwanda" (https://aims.ac.rw/). Earlier in my academic journey, I jointly earned two Bachelor's degrees from the "Université d'Abomey-Calavi" (https://www.uac.bj/): a B.Sc. in Computer Science (Software Engineering) from the "Institut de Formation et de Recherche en Informatique (IFRI)" (https://ifri-uac.bj/) and a B.Sc. in Applied Mathematics from the "Faculty of Science and Technology (FAST)" (https://www.uac.bj/ufr-entites-facultes-instituts-centres-uac/). For further details regarding my academic background and professional experience, please refer to my "CV" (/files/Christophe_Hounanou_CV.pdf).
